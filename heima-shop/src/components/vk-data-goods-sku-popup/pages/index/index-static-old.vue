...
<template>
	<view class="app">
		...
		<vk-data-goods-sku-popup ref="skuPopup" v-model="skuKey" border-radius="20" :custom-action="findGoodsInfo"
			:mode="skuMode" @open="openSkuPopup" @close="closeSkuPopup" @cart="addCart"
			@buy="buyNow"></vk-data-goods-sku-popup>
	</view>
</template>
